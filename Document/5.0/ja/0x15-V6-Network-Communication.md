# V6 ネットワーク通信セキュリティ (Network Communication Security)
...
## V6.1 トランスポート層セキュリティ (Transport Layer Security)
...
## V6.2 ネットワークサービスの露出 (Network Service Exposure)
...
## V6.3 ネットワークデータ漏洩防止 (Network Data Leakage Prevention)
...
## V6.4 プロセス間通信とローカルネットワーク通信 (Inter-Process and Local Network Communication)
...
## V6.5 ライセンスサーバーとの通信 (License Server Communication)
