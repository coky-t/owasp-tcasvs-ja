# V3 データストレージと保護 (Data Storage and Protection)
...
## V3.1 データ分類とポリシー (Data Classification and Policy)
...
## V3.2 ファイルと設定内の機密データ (Sensitive Data in Files and Configuration)
...
## V3.3 クレデンシャルとシークレットの保管 (Credential and Secret Storage)
...
## V3.5 一時データと残存データ (Temporary and Residual Data)
